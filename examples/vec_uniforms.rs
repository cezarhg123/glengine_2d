...
fn main() {
    ...
    let shader = Shader::new(include_str!("../shaders/image_uniform.vert"), include_str!("../shaders/image_uniform.frag"));
    shader.use_program();
    shader.set_uniform(uniform("pos_offset", UniformType::Vec2(0.2, 0.2)));
